...
numComponents = 20; % Adjust the number of components based on your analysis
...
individualOOBError = rfModel.OOBIndices;
numTrees = size(individualOOBError, 2);
...
oobErrorReduced = oobError(rfModelReduced);
figure;
plot(oobErrorReduced);
xlabel('Number of Grown Trees');
ylabel('Out-of-Bag Classification Error');
